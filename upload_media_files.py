...
def upload_media():
    ...
    try:
        ...
        for media_file in media_files:
            try:
                ...
                if file_ext in [".jpg", ".jpeg", ".png"]:
                    ...
                    print(f"Unsupported file type: {file_ext} - skipping {media_file}")
                    continue
        ...
        print(f"Successfully uploaded {len(uploaded_media_ids)} media files")
        print(f"Media IDs: {uploaded_media_ids}")
